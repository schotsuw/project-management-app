...
if (error) {
  ...
  return <div>An error occurred while fetching tasks: {JSON.stringify(error, null, 2)}</div>;
}
...
const Task = ({ task }: TaskProps) => {
  ...
  const Prioritytag = ({ priority }: { priority: TaskType["priority"]}) => (
    <div className={`rounded-full px-2 py-2 text-xs font-semibold ${
      priority === "Urgent"
  ...
  return (
    ...
    className={`mb-4 rounded-md bg-white shadow dark:bg-dark-secondary ${
      ...
      {task.attachments && task.attachments.length > 0 && (
        <Image 
          src={`https://pms-3-images.s3.us-east-1.amazonaws.com/${task.attachments[0].fileURL}`}
          ...
          <div className='p-4 md:p-6'>
            <div className='flex items-start justify-between'>
              ...
              <button className='flex h-6 w-4 flex-shrink-0 items-center justify-center dark:text-neutral-500'>
                ...
                <div className='my-3 flex justify-between'>
                  ...
                  {typeof task.points === "number" && (
                    <div className='text-xs fint-semibold dark:text-white'>
                      {task.points} pts
                    </div>
                  )}
                </div>
              ...
              <p className='text-sm text-gray-600 dark:text-nuetral-500'>
                {task.description}
              </p>
                ...
                <div className='flex -space-x-[6px] overflow-hidden'>
                  {task.assignee && (
                    <Image
                      ...
                      src={`https://pms-3-images.s3.us-east-1.amazonaws.com/${task.assignee.profilePictureUrl!}`}
                  ...
                  {task.author && (
                    <Image
                      ...
                      src={`https://pms-3-images.s3.us-east-1.amazonaws.com/${task.author.profilePictureUrl!}`}
