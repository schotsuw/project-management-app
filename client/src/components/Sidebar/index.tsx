...
import { LockIcon, LucideIcon, Home, X, Briefcase, 
  Search, Settings, User, Users, ChevronUp, ChevronDown, 
  AlertCircle, ShieldAlert, AlertTriangle, AlertOctagon, 
    ...
    <div className={sidebarClassNames}>
      <div className='flex h-[100%] w-full flex-col justify-start'>
        ...
        <div className='flex items-center gap-5 border-y-[1.5px] border-gray-200 px-8 py-4 dark:border-gray-700'>
          <Image 
            src='https://pms-3-images.s3.us-east-1.amazonaws.com/Preview.png' 
            alt="Logo" 
            width={50} 
            height={50} 
        ...
        <div className='flex w-full items-center'>
          <div className='align-center flex h-9 w-9 justify-center'>
            {!!currentUserDetails?.profilePictureUrl ? (
              <Image
                src={`https://pms-3-images.s3.us-east-1.amazonaws.com/${currentUserDetails.profilePictureUrl}`}
